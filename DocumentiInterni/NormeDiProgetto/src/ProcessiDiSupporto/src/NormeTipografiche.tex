...
\subsubsection{Sigle}
Nei documenti prodotti dal gruppo {\Gruppo}, è possibile adotterre le seguenti sigle per abbreviazione dei nomi più ricorrenti, quali:
\begin{itemize}
...
%\end{itemize}
Ogni immagine, sarà correlata da una breve descrizione della stessa, posizionata in centro pagina.

%\subsubsection{Diagrammi \glo{UML}}
%Ogni diagramma \glo{UML} inserito all’interno della documentazione avrà estensione png. Il programma atto alla creazione dei diagrammi \glo{UML} sarà Draw.IO.
