...
\begin{itemize}
	...
	\item i nomi dei documenti utilizzeranno la seguente nomenclatura: \textbf{NomeDelFile_v. X.Y.Z}, dove X,Y e Z indicano la versione del documento;
\end{itemize}
...
\end{itemize}
Ogni immagine, in aggiunta, sarà correlata da una breve descrizione della stessa, e posizionata in centro pagina.
