...
\myparagraph{Configurazione dell'infrastruttura}
...
\myparagraph{Comunicazione e meeting}
...
\myparagraph{Controllo delle versioni, issue tracking system e memorizzazione remota condivisa}
