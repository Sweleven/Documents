...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{O}: obbligatorio, cio\'{strettamente necessario;
        \item \textbf{D}: desiderabile, cio\'{non strettamente necessario;
        \item \textbf{F}: facoltativo, cio\'{contrattabile in corso d'opera;
    \end{itemize}
