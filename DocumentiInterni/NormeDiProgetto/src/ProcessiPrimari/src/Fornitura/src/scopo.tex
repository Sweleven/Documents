...
\begin{itemize}
    ...
    \item redigere un documento che descriva in modo dettagliato l'organizzazione secondo cui il fornitore pianificher\`{a} le attivit\`{a} durante tutte le fasi del progetto; % RIVEDERE QUESTO ITEM
