...
\item Competenze lato \glo{client}/\glo{server};
\item Studio delle tecnologie e librerie proposte;
\item Conoscenza funzionamento e protocolli \glo{RFID};
\end{itemize}
...
\end{itemize}
\item Sviluppo di un'applicazione mobile per dispositivi con sistema \glo{Android} oppure \glo{iOS} che deve permettere:
\begin{itemize}
