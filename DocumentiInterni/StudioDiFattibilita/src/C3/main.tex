...
\begin{itemize}
    ...
    \item competenze nello sviluppo di \glo{backend} e front-end di applicativi web;
    \item conoscenze sul funzionamenteo dei protocolli asincroni.
\end{itemize}
\subsection{Tecnologie coinvolte}
\begin{itemize}
    \item \glo{Java} e \glo{TypeScript}: usati per lo sviluppo di \glo{backend} e front-end della Web Application;
...
riguardanti l'analisi di dati e sviluppo di interfacce web sia front che \glo{backend}.
