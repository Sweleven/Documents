...
\item consegna materiale pre Progettazione(design):documentazione analisi AppSync/Gamelift, Diagramma \glo{UML} \glo{use-cases},\glo{Schema Design} Basi di dati,documentazione API(dettagliata),piano di \glo{unit-test}
