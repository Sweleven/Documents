...
\input{src/ResocontoVerifica/src/Esito_revisione_requisiti.tex}


\subsubsection{Revisione di progettazione}
\paragraph{Analisi statica del codice}\mbox{}\\
\input{src/ResocontoVerifica/src/Analisi_codice.tex}


\subsection{Calcolo metriche}
\subsubsection{Tecnology Baseline}
\input{src/ResocontoVerifica/src/Premessa_TB.tex}
