L'ultimo stadio conclude la fase di validazione e prevede il controllo e la rifinitura generale di tutto il lavoro. L'obiettivo è perciò consegnare il progetto nella sua interezza, assicurandosi di aver soddisfatto con successo tutti i requisiti richiesti sia dal proponente che dal committente. Gli obiettivi che si prepone fungono quindi da \glo{milestone} finale e devono essere soddisfatti conformemente a quanto richiesto dal quarto ed ultimo incontro di revisione programmato.
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item consegna di tutto il \glo{deliverable}, in vista dell'incontro con il committente per la \RA{}.
        \end{itemize}