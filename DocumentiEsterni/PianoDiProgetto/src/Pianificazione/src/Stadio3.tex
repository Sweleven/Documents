Una volta approvati i \glo{requisiti} di ingresso, in seguito all'aggiudicazione ufficale del capitolato, il gruppo procede verso la \glo{fase} progettuale attraverso un primo stadio progettuale. Appoggiandosi all'\AdR{}, in questo periodo lo scopo principale è definire e preparare tutti gli aspetti preliminari allo sviluppo vero e proprio, avviando così la progettazione architetturale del prodotto.
