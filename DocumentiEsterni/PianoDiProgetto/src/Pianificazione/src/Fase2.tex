Svolte le attività preliminari, il gruppo si concentra più in dettaglio nell'analisi del capitolato scelto e redige una prima stesura della documentazione esterna. L'obiettivo principale di questa fase è ottenere quindi il \glo{deliverable} richiesto per il primo incontro di revisione programmato. Questa fase corrisponde alla prima \glo{milestone} ufficiale del gruppo.
