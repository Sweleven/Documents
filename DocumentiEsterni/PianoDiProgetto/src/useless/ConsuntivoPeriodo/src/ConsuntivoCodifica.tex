...
{
\rowcolors{2}{\primaryColor}{\secondaryColor}
...
\begin{itemize}
	...
	\item \textbf{Amministratore e Responsabile}: Come per la precedente \glo{fase}, nonostante il lieve discostamento, possiamo notare che sono stati preventivati correttamente i numeri di ore richieste per il ruolo;
