...
Il bilancio della \glo{fase} di Analisi è negativo, ovvero il gruppo ha impiegato più ore di quelle anticipate, quindi il costo finale della fase di Analisi supera l'aspettativa calcolata in precedenza.\\
...
\begin{itemize}
	...
	\item \textbf{Analista}: Sono servite più ore del previsto per ottenere una struttura coesa e dettagliata dei \glo{requisiti};
...
Il costo effettivo di questa prima \glo{fase} non ha influenza sul preventivo in quanto esso si basa solamente sui costi preventivati nelle fasi successive di Progettazione Architetturale, Progettazione di Dettaglio e Codifica, Validazione e Collaudo.\\
