...
\begin{itemize}
    ...
    \item il grado di occorrenza (in questo caso indicativo di quante volte si sia realmente verificato);
    \item una breve descrizione più specifica dell'evenienza e di come sia stata effettivamente mitigata.
\end{itemize}
{
