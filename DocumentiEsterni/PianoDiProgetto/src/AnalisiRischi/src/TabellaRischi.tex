...
del progetto. \\
        ...
        \hline
        RRa &
        Incomprensione dei requisiti richiesti,
        può accadere all’inizio
        del progetto
        con poche conseguenze,
        ma se accade
        a progetto inoltrato
        il problema
        può rivelarsi molto
        serio &
        media &
        alta &
        Deve essere rilevato prima di procedere alla fase di progettazione in modo da avere chiaro i requisiti facendo un analisi critica di tale fase. &
        Da prevenire possibilmente facendo un analisi critica della fase di analisi ed apportare eventuali modifiche.  \\
       \hline
        RRb &
        Cliente poco presente
        Rischio che prevede
        contatti poco frequenti
        e/o di scarso
        aiuto con l’azienda
        proponente che mostra
        poco interesse &
        bassa &
        alta &
...
\hline
RSa &
Per ogni incremento verrà stimato il costo di tempo, denaro e risorse utilizzate. A causa dell’inesperienza questa stima potrebbe essere errata &
alta &
media &
Se un membro del gruppo si accorge/pensa di non attenersi alla pianificazione e quindi termina prima o dopo del tempo prestabilito o utilizza risorse e denaro non come previsto,dovrà farlo presente al responsabile di progetto(legato a ROc) &
Organizzare un’attenta pianificazione in modo da ridurre questo rischio e qualora si presentasse un eccesso troppo alto il responsabile dovrà
ridistribure:le risorse,il carico di lavoro per ammortizzare i tempi e/o costi e svolgere quanto prefissato e come nel periodo di tempo specifico  \\
