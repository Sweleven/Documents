...
\TermineGlossario{smart contract}
\DefinizioneGlossario{È il codice che viene eseguito su una blockchain. Esso può accettare ed archiviare criptovaluta, dati o la combinazione di entrambi distribuendoli ad altri account o persino ad altri smart contract.}
...
\TermineGlossario{StarUML}
\DefinizioneGlossario{Strumento per la generazione automatica di codice Java a partire dalla sua rappresentazione UML; è possibile, inoltre, effettuare l'operazione inversa (reverse engineer) del codice Java sorgente per produrre il diagramma UML corrispondente.}

\TermineGlossario{stadio} 
\DefinizioneGlossario{Si intende la sotto-fase relativa alla pianificazione del progetto \NomeProgetto{} da parte del gruppo \Gruppo{}. Da considerarsi come delle \glo{milestone} minori, con relativi obiettivi che il gruppo intende raggiungere entro la fine delle stesse.}
