...
\DefinizioneGlossario{(precedentemente iPhone OS) è un sistema operativo mobile sviluppato da Apple per iPhone, iPod touch e iPad (Dispositivi embedded del azienda Apple). È il secondo sistema operativo mobile più installato al mondo, dopo Android.}
