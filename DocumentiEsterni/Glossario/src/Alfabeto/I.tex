...
\TermineGlossario{incrementale (modello)}
\DefinizioneGlossario{Si intende, nell'ambito dell'ingegneria del software, un modello adattivo di sviluppo di un progetto software, basato sulla successione di specifici passi principali. Prevede rilasci multipli, realizzando un incremento di funzionalità e avvicinandosi sempre più alle attese.}
...
\TermineGlossario{Internet of Things (IoT)}
...
\DefinizioneGlossario{(precedentemente iPhone OS) è un sistema operativo mobile sviluppato da Apple per iPhone, iPod touch e iPad (Dispositivi embedded del azienda Apple). È il secondo sistema operativo mobile più installato al mondo, dopo \glo{Android}.}

\TermineGlossario{ISO}
\DefinizioneGlossario{(L'Organizzazione internazionale per la normazione, è la più importante organizzazione a livello mondiale per la definizione di norme tecniche. Svolge funzioni consultive per l'Organizzazione delle Nazioni Unite per l'educazione, la scienza e la cultura.}
