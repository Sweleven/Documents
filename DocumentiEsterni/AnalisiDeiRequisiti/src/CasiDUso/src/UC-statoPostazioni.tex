...
\begin{figure}[H]
  \centering
    \includegraphics[scale=0.65]{src/CasiDUso/immagini/UC-statoPostazioni.png}
  \caption{Stato prenotazioni}
\end{figure}

\begin{figure}[H]
	\centering
	  \includegraphics[scale=0.65]{src/CasiDUso/immagini/PostazioniStanze.png}
	\caption{Stato prenotazioni}
  \end{figure}
...
\subsection{UC-21 Marca postazione igienizzata}
...
\subsection{UC-22 Marca postazione sporca}
...
\subsection{UC-23 Marca postazione occupata}
...
\subsection{UC-24 Contrassegna postazione abilitata}
