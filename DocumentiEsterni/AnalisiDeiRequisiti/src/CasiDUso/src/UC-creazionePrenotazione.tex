...
\item \textbf{Scenario principale:} 
	\begin{itemize}
		\item l'attore seleziona la nuova data in cui desidera prenotare una postazione[UC-16.1];
		\item l'attore seleziona la nuova stanza in cui vuole prenotare una postazione dalla lista delle stanze abilitate[UC-16.2];
		...
		\item l'attore seleziona la nuova postazione che desidera prenotare[UC-16.3];
		\item l'attore seleziona il nuovo orario della prenotazione tra la lista degli orari in cui la prenotazione è libera ed igienizzata[UC-16.4];
		\item il sistema elabora correttamente la richiesta, mandando in stato di “pending” la prenotazione;
	\end{itemize}
\end{itemize}
...
\item \textbf{Scenario principale:} 
	\begin{itemize}
		...
		\begin{itemize}
			\item non è possibile cancellare una prenotazione per un orario passato[UC-19.1].
		\end{itemize}
	\end{itemize}
\end{itemize}

\subsection{UC-19 Visualizzazione errore di cancellazione: tentativo di cancellazione di una prenotazione per un orario passato}
\begin{itemize}
\item \textbf{Attori primari:} personale interno autenticato;
...
\item \textbf{Postcondizione:} la cancellazione non viene approvata e il personale interno autenticato riceve un messaggio di errore auto-esplicativo;
...
%\begin{itemize}
%\item \textbf{Attori primari:} personale interno autenticato;
%\item \textbf{Precondizione:} il personale interno autenticato sta cercando di visualizzare la lista delle sue prenotazioni, non avendone però alcuna attiva;
