...
\subsubsection{UC 40 - Marca postazione igienizzata}
...
\subsubsection{UC 42 - Marca stanza igienizzata}
...
\subsubsection{UC 42.1 - Visualizzazione errore marcatura stanza: una postazione all'interno della stanza selezionata non è igienizzata}
\begin{itemize}
\item \textbf{Attori primari:} igienizzatore;
