...
\paragraph{UC-39 Creazione di una nuova prenotazione}
    \begin{itemize}
	    ...
	    \item \textbf{Scenario principale:}
	        \begin{enumerate}
		        \item il dipendente seleziona una stanza da una lista di stanze disponibili (UC-.1 Selezione stanza);
		        \item il dipendente seleziona una postazione da una lista di postazioni disponibili all'interno della stanza (UC- .2 Selezione stanza); 
		        \item il dipendente seleziona la data in cui effettuare la prenotazione (UC- .3Seleziona data);
		        \item il dipendente seleziona l'orario in cui intende far partire la prenotazione della postazione (UC- .4 Selezione orario d'inizio);
		        \item il dipendente seleziona la durata della propria prenotazione (UC- .5 Selezione della durata);
	        \end{enumerate}
    \end{itemize}
...
\paragraph{UC-39.2 Selezione postazione}
...
\paragraph{UC-39.3 Selezione data}
...
\paragraph{UC-39.4 Selezione fascia oraria}
...
\paragraph{UC-39.5 Selezione della durata}
...
\paragraph{UC-40 Visualizzazione delle prenotazioni effettuate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Scenario principale:}
            \begin{enumerate}
                 \item il sistema restituisce un elenco contenente tutte le prenotazioni effettuate da un dipendente. Il dipendente può visualizzare l'ID (UC- .1 Visualizzazione id prenotazione), la data (UC- .2 Visualizzazione data), l'ora di inizio (UC- .3 Visualizzazione orario d'inizio), la stanza (UC- .4 Visualizzazione stanza), il codice della postazione prenotata (UC- .5 Visualizzazione codice postazione) e la durata (UC- .6 Visualizzazione della durata della prenotazione) a partire da una singola prenotazione;
            \end{enumerate}
    \end{itemize}
...
\paragraph{UC-40.3 Visualizzazione orario d'inizio}
...
\paragraph{UC-.6 Visualizzazione della durata della prenotazione}
    ...
    \begin{itemize}
        ...
        \item \textbf{Scenario principale:}
            \begin{enumerate}
                ...
                \item il dipendente scansiona il tag RFID della postazione per segnalare l'avvenuta igienizzazione (UC- .1 Scansione del tag RFID per segnalare l'avvenuta igienizzazione);
    ...
    \begin{itemize}
        ...
        \item \textbf{Scenario principale:}
            \begin{enumerate}
                ...
                \item il dipendente scansiona il tag RFID della postazione in cui è seduto (UC- .1 Scansione del tag RFID per segnalare la propria presenza nella postazione);
                \item il sistema fornisce informazioni relative allo stato della postazione (UC-.2 Visualizzazione informazioni postazione). Qualora la postazione risulti non disabilitata o non occupata il sistema invierà una richiesta di avvio dell'utilizzo;
                \item il dipendente conferma l'utilizzo della postazione (UC- .3 Avvio utilizzo);
                \item il sistema aggiorna lo stato della postazione da libera a occupata.
            \end{enumerate}
    \end{itemize} 


\paragraph{UC-43.1 Scansione del tag RFID per segnalare la propria presenza nella postazione}
